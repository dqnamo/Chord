...
const EDGE_GAP = 16;
const STORAGE_KEY = "dqnamo-floating-panel-corner";
...
function ThemeFooter({ isRightAligned }: { isRightAligned: boolean }) {
  ...
  return (
    ...
    >
      ...
      <nav
        ...
        className={cn(
          "flex flex-col gap-px py-2",
          isRightAligned && "items-end text-right",
        )}
      >
        {children}
      </nav>
      <ThemeFooter isRightAligned={isRightAligned} />
    </aside>
  );
}
